...
Original file is located at
    https://colab.research.google.com/drive/1M270I6Hebxw7wOnRxM5E0GiICG4MvZJL
...
1. Click on this link to open the Colab file for this project.
  ...
  https://colab.research.google.com/drive/1LyiJiGzlhTQLskXk9E-ZMWejk50NM9aL
...
st.sidebar.title("Census Data Graph of the web app")
st.title("Census Data Graph of the web app")
...
**A:** `Pie chart` plot can be used to display the distribution of records for the `income-group` feature.

**Q:** Which chart/plot can be used to display the distribution of records for the `gender` feature.

**A:** `Pie chart` plot can be used to display the distribution of records for the `gender` feature.
...
**A:** `Box plot` can be used to display the difference in the range of values for the `hours-per-week` feature for different gender groups.
...
**A:** `count plot` can be used to display the count of a number of records for unique `workclass` feature values for different income groups.
...
- Interpretation 1: In the first interpretation, pie chart is used to display the distribution of records for the income group.

- Interpretation 2: In the second interpretation, pie chart is used to display the distribution of records for the gender feature.

- Interpretation 3: In the third interpretation, box plot is used to display the difference in the range of values for the `hours-per-week` feature for different gender groups.

- Interpretation 4: In the fourth interpretation, box plot is used to display the difference in the range of values for the hours-per-week feature for different gender groups.

- Interpretation 5: In the fifth interpretation, be used to display the count of a number of records for unique workclass feature values for different income groups.
